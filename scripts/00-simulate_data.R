...
ggplot(sim_data, aes(x = ward_id, y = number_voted)) +
  geom_point() +
  labs(
    title = "Number of People Voted by Ward",
    x = "Ward ID",
...
ggplot(sim_data, aes(x = ward_id, y = percent_voted)) +
  geom_point() +
  labs(
    title = "Percentage of People Voted by Ward",
    x = "Ward ID",
...
ggplot(sim_data, aes(x = ward_id, y = num_sub)) +
  geom_point() +
  labs(
    title = "Number of Subdivisions by Ward",
    x = "Ward ID",
...
ggplot(sim_data, aes(x = ward_id, y = percent_uneducated)) +
  geom_point() +
  labs(
    title = "Percentage of Uneducated People by Ward",
    x = "Ward ID",
...
ggplot(sim_data, aes(x = ward_id, y = unemployment_rate)) +
  geom_point() +
  labs(
    title = "Unemployment Rate by Ward",
    x = "Ward ID",
    y = "Unemployment Rate"
  )
